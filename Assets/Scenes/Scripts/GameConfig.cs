...
{
    public enum Level { Level1, Level2, Level4 }
    ...
    public static int totalApples = 12; // Total de manzanas a repartir
    public static int numberOfFriends = 4; // Número de amigos
}
